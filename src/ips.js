...
const conf = require('./routes/client_config');
const axios = require('axios');

function getIPS(id, patId, persona) {
    ...
    // var MyDomain = 'http://www.msal.gov.ar'; //https://conn28dummy.org.ar
    var cnd = conf.authConfig();
    var MyDomain = cnd.iss //https://conn28dummy.org.ar
    ...
    var org = {
        ...
        "active": true,
        "name": "Connectathon 28 CAIS Dummy",
        "telecom": [
            {
                "system": "phone",
                "value": "+54-9999-9999",
    ...
    // Referencia a esta Organization
    ...
    // generalPractitioner
    // El nuestro tiene un poco menos de info
    PatientSystem = patId[0];
    PatientValue = patId[1];
    ...
    pat = {
        ...
        name: [{
            use: "official",
            family: persona.family,// "Apellido Fijo",
            given: persona.given//[
            //     "Nombre Fijo"
            // ]
        ...
        birthDate: persona.birthDate //"1999-09-09"
    ...
    */
    ...
    var imm =
    {
        ...
        "text": {
            status: "generated",
            div: '<div xmlns="http://www.w3.org/1999/xhtml"> Sin vacunas informadas</div>'
        },
        "patient": {
